...
As an end result, this project delivers an interactive Power BI dashboard presenting key metrics such as EVs per charging connector, with the ability to filter by date and Territorial Local Authority(TLA). The project implements a full end-to-end data pipeline, using Alteryx to ingest, clean, and reformat raw JSON data, and Snowflake as a data warehouse for data modelling and analytics. 
